...
foreach ($diasvencido as $dias) {
    $sql = "SELECT upper(vtab_titulos.nome_res) as nome_res, 
            ...
            WHERE vtab_titulos.status = 'vencido' AND vtab_titulos.cli_ativado = 's'
    ...
    echo "[" . date('Y-m-d H:i:s') . "] Analisando títulos para regra de $dias dia(s) após vencimento...\n";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        // Data teórica de envio (X dias após o vencimento)
