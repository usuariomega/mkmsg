...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['posttodos'])) {
        ...
        echo '<div class="card">';
        echo '<h3>📤 Processando Envios (Todos Vencidos)...</h3>';
        ...
        echo '<br><button class="button mt-3" onclick="window.location.href=\'vencido.php?menumes='.$valorsel.'\'">Fechar</button>';
        echo '</div></div></div>';
        ob_end_flush();
        exit;
...
<div class="container">
    ...
    <form id="form" method="post">
        ...
        <div class="menu mt-3">
            <button class="button" name="posttodos" type="submit" onclick="return confirm('✅ Enviar para TODOS os <?= $total_registros ?> registros vencidos?')" style="background-color: var(--success);">📤 Enviar para todos</button>
